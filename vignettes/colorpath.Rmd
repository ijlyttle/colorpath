...
A couple notes on the diverging palettes: 
...
tmp <- farver::compare_colour(
  from = pal_blues_div_dark(seq(0, 1, by = dx)),
  from_space = "luv",
  method = "cie2000"
)
...
The output is a bit cryptic - this demands its own function - we should read this along the first superdiagonal.
